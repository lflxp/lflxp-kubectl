...
func Services(g *gocui.Gui, v *gocui.View) error {
	...
	if v, err := g.SetView("Serviceed", 0, 0, origin.maxX-1, origin.maxY-1); err != nil {
		...
		tableNow.AddCol("Namespace").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		...
		tableNow.AddCol("CLUSTER-IP").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("EXTERNAL-IP").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("PORT(S)").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("AGE").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("SELECTOR").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")

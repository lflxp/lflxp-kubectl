...
func Node(g *gocui.Gui, v *gocui.View) error {
	...
	if v, err := g.SetView("Noded", 0, 0, origin.maxX-1, origin.maxY-1); err != nil {
		...
		tableNow.AddCol("STATUS").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("ROLES").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("AGE").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("VERSION").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("INTERNAL-IP").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("OS-IMAGE").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("KERNEL-VERSION").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("CONTAINER-RUNTIME").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
		tableNow.AddCol("LABELS").SetColor("dgreen").SetTextAlign(TextLeft).SetBgColor("black")
